...
import ThemePreview from "./ThemePreview"; // 🔥 importe d'abord
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-3xl shadow-xl">
        <h2 className="text-2xl font-bold text-center text-green-600 mb-8">Choisissez un Thème pour votre Boutique</h2>
