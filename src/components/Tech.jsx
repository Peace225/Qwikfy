...
import CheckoutPopup from "./CheckoutPopup"; // ✅ On importe ton composant Popup
...
export default function Tech() {
  ...
  return (
    <section className="bg-lime-100 py-6 px-4 mt-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {produitsTech.map((item, i) => (
          <div
            ...
            onClick={() => setSelectedProduct(item)} // ✅ Clique pour ouvrir le produit
          >
      ...
      {/* ✅ Afficher le popup Checkout si un produit est sélectionné */}
      {selectedProduct && (
        <CheckoutPopup
